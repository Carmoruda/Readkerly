...
def reading_schedule_goal():
    ...
    schedule_goal = input("How many days do you want to read per week? (days): ")
...
def reading_time_goal():
    ...
    time_goal = input("How much time do you want to read per day? (mins): ")
    continue_value = input("Press Enter to continue...")
...
def books_goal():
    ...
    print(titles["books"])
    year_goal = input("How many books do you want to read in a year?: ")
    continue_value = input("Press Enter to continue...")
...
def menu():
    ...
    print(f"{titles['welcome']}\nWelcome!! I'm Kerly, your new personasl assistant.")
    username = input("How should I  call you?: ")

    print(f"\n{username} Let's start by setting up your reading goals.")
    continue_value = input("Press Enter to continue...")

    enter_pressed(continue_value, books_goal, menu)
